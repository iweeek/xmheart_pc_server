...
public interface XPWColumnMapper {
     ...
     * This method corresponds to the database table xpw_column
     *
     ...
     */
    @Insert({
        "insert into xpw_column (column_name, url, ",
        "parent_column_id, publish_time)",
    ...
    @Select({
        "select",
        "id, column_name, url, parent_column_id, publish_time",
        "from xpw_column",
        "where id = #{id,jdbcType=BIGINT}"
    })
    ...
    @Update({
        ...
        "set column_name = #{columnName,jdbcType=VARCHAR},",
          ...
          "parent_column_id = #{parentColumnId,jdbcType=BIGINT},",
