...
<<<<<<< HEAD
     ...
     * @mbg.generated  Thu Sep 21 10:30:58 CST 2017
     */
     ...
     * @mbg.generated  Thu Sep 21 15:03:21 CST 2017
     */
    @Insert({ "insert into xpw_column (column_name, url, ", "parent_column_id, publish_time)",
            "values (#{columnName,jdbcType=VARCHAR}, #{url,jdbcType=VARCHAR}, ",
            "#{parentColumnId,jdbcType=BIGINT}, #{publishTime,jdbcType=TIMESTAMP})" })
     ...
     * @mbg.generated  Thu Sep 21 15:03:21 CST 2017
     */
    @Select({ "select", "id, column_name, url, parent_column_id, publish_time", "from xpw_column",
