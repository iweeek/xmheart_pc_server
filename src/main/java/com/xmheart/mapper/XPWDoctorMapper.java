...
<<<<<<< HEAD
     ...
     * @mbg.generated  Thu Sep 21 10:30:59 CST 2017
     */
    @Insert({ "insert into xpw_doctor (name, dept_id, ", "dept_name, duty, ", "professional_title, grade, ",
            "intro, url, image_url)", "values (#{name,jdbcType=VARCHAR}, #{deptId,jdbcType=BIGINT}, ",
            "#{deptName,jdbcType=VARCHAR}, #{duty,jdbcType=VARCHAR}, ",
            "#{professionalTitle,jdbcType=VARCHAR}, #{grade,jdbcType=VARCHAR}, ",
            "#{intro,jdbcType=VARCHAR}, #{url,jdbcType=VARCHAR}, #{imageUrl,jdbcType=VARCHAR})" })
     ...
     * @mbg.generated  Thu Sep 21 10:30:59 CST 2017
     */
    @Select({ "select", "id, name, dept_id, dept_name, duty, professional_title, grade, intro, url, image_url",
...
=======
	 ...
	 */
	@Insert({ "insert into xpw_doctor (name, dept_id, ", "dept_name, duty, ", "professional_title, grade, ",
			"url, image_url, intro)", "values (#{name,jdbcType=VARCHAR}, #{deptId,jdbcType=BIGINT}, ",
			"#{deptName,jdbcType=VARCHAR}, #{duty,jdbcType=VARCHAR}, ",
			"#{professionalTitle,jdbcType=VARCHAR}, #{grade,jdbcType=VARCHAR}, ",
			"#{url,jdbcType=VARCHAR}, #{imageUrl,jdbcType=VARCHAR}, #{intro,jdbcType=LONGVARCHAR})" })
	@SelectKey(statement = "SELECT LAST_INSERT_ID()", keyProperty = "id", before = false, resultType = Long.class)
	int insert(XPWDoctor record);
	 ...
	 * @mbg.generated  Mon Sep 18 22:36:15 CST 2017
	 */
	@Select({ "select", "id, name, dept_id, dept_name, duty, professional_title, grade, url, image_url, ", "intro",
			"from xpw_doctor", "where id = #{id,jdbcType=BIGINT}" })
	...
	@Update({ "update xpw_doctor", "set name = #{name,jdbcType=VARCHAR},", "dept_id = #{deptId,jdbcType=BIGINT},",
			"dept_name = #{deptName,jdbcType=VARCHAR},", "duty = #{duty,jdbcType=VARCHAR},",
...
>>>>>>> 5e0876cb5b930a7c41b1f6695d2aa45c0c45363b
