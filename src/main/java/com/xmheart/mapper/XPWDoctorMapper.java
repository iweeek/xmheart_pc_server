...
public interface XPWDoctorMapper {
	...
	@Insert({ "insert into xpw_doctor (name, dept_id, ", "duty, professional_title, ", "grade, url, image_url, ",
			"dept_name, intro)", "values (#{name,jdbcType=VARCHAR}, #{deptId,jdbcType=BIGINT}, ",
			...
			"#{deptName,jdbcType=VARCHAR}, #{intro,jdbcType=LONGVARCHAR})" })
	 ...
	 * @mbg.generated  Mon Sep 18 07:36:33 CST 2017
	 */
	@Select({ "select", "id, name, dept_id, duty, professional_title, grade, url, image_url, dept_name, ", "intro",
	...
	@Update({ "update xpw_doctor", "set name = #{name,jdbcType=VARCHAR},", "dept_id = #{deptId,jdbcType=BIGINT},",
			...
			"image_url = #{imageUrl,jdbcType=VARCHAR},", "dept_name = #{deptName,jdbcType=VARCHAR},",
