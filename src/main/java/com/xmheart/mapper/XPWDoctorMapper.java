...
public interface XPWDoctorMapper {
    ...
    @Insert({ "insert into xpw_doctor (name, dept_id, ", "duty, professional_title, ", "grade, intro, url, ",
            "image_url)", "values (#{name,jdbcType=VARCHAR}, #{deptId,jdbcType=BIGINT}, ",
     ...
     * @mbg.generated  Wed Sep 27 20:43:28 CST 2017
     */
    @Select({ "select", "id, name, dept_id, duty, professional_title, grade, intro, url, image_url", "from xpw_doctor",
