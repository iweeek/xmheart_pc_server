...
public interface XPWDoctorMapper {
     ...
     * This method corresponds to the database table xpw_doctor
     *
     ...
     */
    @Insert({
        "insert into xpw_doctor (name, dept, ",
    ...
    @Select({
        "select",
        "id, name, dept, duty, professional_title, grade, url, image_url, intro",
        "from xpw_doctor",
        "where id = #{id,jdbcType=BIGINT}"
    })
