...
public interface XPWUserMapper {
	 ...
	 * @mbg.generated  Sat Oct 28 17:01:43 CST 2017
	 */
	@Insert({ "insert into xpw_user (username, password, ", "user_type, latest_token, ", "avatar_url, role_id)",
			"values (#{username,jdbcType=VARCHAR}, #{password,jdbcType=VARCHAR}, ",
			"#{userType,jdbcType=BIT}, #{latestToken,jdbcType=VARCHAR}, ",
			"#{avatarUrl,jdbcType=VARCHAR}, #{roleId,jdbcType=BIGINT})" })
	 ...
	 * @mbg.generated  Sat Oct 28 17:01:43 CST 2017
	 */
	@Select({ "select", "id, username, password, user_type, latest_token, avatar_url, role_id", "from xpw_user",
