...
public interface XPWOnlineVideoMapper {
     ...
     * This method corresponds to the database table xpw_online_video
     *
     ...
     */
    @Insert({
        "insert into xpw_online_video (title, url, ",
        "img_url, video_url, ",
        "brief, is_pinned, ",
    ...
    @Select({
        "select",
        "id, title, url, img_url, video_url, brief, is_pinned, is_published, publish_time",
        "from xpw_online_video",
        "where id = #{id,jdbcType=BIGINT}"
    })
     ...
     * @mbg.generated Thu Nov 02 15:33:26 CST 2017
     */
    int updateByExampleSelective(@Param("record") XPWOnlineVideo record, @Param("example") XPWOnlineVideoExample example);
