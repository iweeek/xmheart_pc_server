...
public interface XPWDeptMapper {
    ...
    @Insert({ "insert into xpw_dept (name, image_url, ", "url, dept_doctor_url, ", "out_service, admin_expert_id, ",
            "is_displayed, intro)", "values (#{name,jdbcType=VARCHAR}, #{imageUrl,jdbcType=VARCHAR}, ",
     ...
     * @mbg.generated  Sun Oct 22 23:06:15 CST 2017
     */
    @Select({ "select", "id, name, image_url, url, dept_doctor_url, out_service, admin_expert_id, is_displayed, ",
            "intro", "from xpw_dept", "where id = #{id,jdbcType=BIGINT}" })
