...
public interface XPWDeptMapper {
	 ...
	 * @mbg.generated  Thu Sep 07 16:26:06 CST 2017
	 */
	@Insert({ "insert into xpw_dept (name, image_url, ", "intro)",
			"values (#{name,jdbcType=VARCHAR}, #{imageUrl,jdbcType=VARCHAR}, ", "#{intro,jdbcType=LONGVARCHAR})" })
	 ...
	 * @mbg.generated  Thu Sep 07 16:26:06 CST 2017
	 */
	@Select({ "select", "id, name, image_url, intro", "from xpw_dept", "where id = #{id,jdbcType=BIGINT}" })
