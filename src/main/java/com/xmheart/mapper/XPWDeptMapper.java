...
public interface XPWDeptMapper {
	...
	@Select("SELECT d.id as id, d.his_id as his_id, d.name as name, d.image_url as image_url,d.img_url as img_url, d.intro as intro, d.dept_doctor_url as dept_doctor_url, "
