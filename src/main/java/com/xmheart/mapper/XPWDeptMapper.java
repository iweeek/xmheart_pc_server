...
<<<<<<< HEAD
     ...
     * @mbg.generated  Thu Sep 21 10:30:59 CST 2017
     */
    @Insert({ "insert into xpw_dept (name, image_url, ", "url, dept_doctor_url, ", "out_service, admin_expert_id, ",
            "intro)", "values (#{name,jdbcType=VARCHAR}, #{imageUrl,jdbcType=VARCHAR}, ",
            "#{url,jdbcType=VARCHAR}, #{deptDoctorUrl,jdbcType=VARCHAR}, ",
            "#{outService,jdbcType=TINYINT}, #{adminExpertId,jdbcType=BIGINT}, ", "#{intro,jdbcType=LONGVARCHAR})" })
     ...
     * @mbg.generated  Thu Sep 21 10:30:59 CST 2017
     */
    @Select({ "select", "id, name, image_url, url, dept_doctor_url, out_service, admin_expert_id, intro",
            "from xpw_dept", "where id = #{id,jdbcType=BIGINT}" })
