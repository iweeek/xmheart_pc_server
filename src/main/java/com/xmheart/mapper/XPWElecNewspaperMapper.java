...
public interface XPWElecNewspaperMapper {
    ...
    @Insert({ "insert into xpw_electronic_newspaper (column_id, column_name, ", "title, years, times, ",
            "url, download_url, ", "image_url, content)",
            ...
            "#{url,jdbcType=VARCHAR}, #{downloadUrl,jdbcType=VARCHAR}, ",
            "#{imageUrl,jdbcType=VARCHAR}, #{content,jdbcType=VARCHAR})" })
     ...
     * @mbg.generated  Mon Oct 23 12:36:16 CST 2017
     */
    @Select({ "select", "id, column_id, column_name, title, years, times, url, download_url, image_url, ", "content",
    ...
    @Update({ "update xpw_electronic_newspaper", "set column_id = #{columnId,jdbcType=BIGINT},",
            ...
            "url = #{url,jdbcType=VARCHAR},", "download_url = #{downloadUrl,jdbcType=VARCHAR},",
            "image_url = #{imageUrl,jdbcType=VARCHAR},", "content = #{content,jdbcType=VARCHAR}",
