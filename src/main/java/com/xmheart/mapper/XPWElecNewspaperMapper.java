...
public interface XPWElecNewspaperMapper {
    ...
    @Insert({ "insert into xpw_electronic_newspaper (column_id, column_name, ", "title, years, times, ",
            "url, download_url, ", "image_url, publish_time)",
     ...
     * @mbg.generated  Mon Oct 23 15:36:34 CST 2017
     */
    @Select({ "select", "id, column_id, column_name, title, years, times, url, download_url, image_url, ",
            "publish_time", "from xpw_electronic_newspaper", "where id = #{id,jdbcType=BIGINT}" })
