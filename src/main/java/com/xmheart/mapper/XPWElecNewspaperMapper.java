...
public interface XPWElecNewspaperMapper {
     ...
     * @mbg.generated  Mon Oct 23 16:57:26 CST 2017
     */
    @Insert({ "insert into xpw_electronic_newspaper (title, years, ", "times, url, is_published, ",
            "download_url, image_url, ", "publish_time)",
            "values (#{title,jdbcType=VARCHAR}, #{years,jdbcType=VARCHAR}, ",
            "#{times,jdbcType=VARCHAR}, #{url,jdbcType=VARCHAR}, #{isPublished,jdbcType=TINYINT}, ",
            "#{downloadUrl,jdbcType=VARCHAR}, #{imageUrl,jdbcType=VARCHAR}, ", "#{publishTime,jdbcType=TIMESTAMP})" })
     ...
     * @mbg.generated  Mon Oct 23 16:57:26 CST 2017
     */
    @Select({ "select", "id, title, years, times, url, is_published, download_url, image_url, publish_time",
    ...
    @Update({ "update xpw_electronic_newspaper", "set title = #{title,jdbcType=VARCHAR},",
            ...
            "url = #{url,jdbcType=VARCHAR},", "is_published = #{isPublished,jdbcType=TINYINT},",
            "download_url = #{downloadUrl,jdbcType=VARCHAR},", "image_url = #{imageUrl,jdbcType=VARCHAR},",
