...
public interface XPWTeacherMapper {
     ...
     * This method corresponds to the database table xpw_teacher
     *
     ...
     */
    @Insert({
        "insert into xpw_teacher (name, dept_id, ",
        "duty, professional_title, ",
        "grade, brief, intro, ",
        "url, image_url, is_displayed)",
    ...
    @Select({
        "select",
        "id, name, dept_id, duty, professional_title, grade, brief, intro, url, image_url, ",
        "is_displayed",
        "from xpw_teacher",
        "where id = #{id,jdbcType=BIGINT}"
    })
    ...
    @Update({
        ...
        "set name = #{name,jdbcType=VARCHAR},",
          ...
          "is_displayed = #{isDisplayed,jdbcType=TINYINT}",
        "where id = #{id,jdbcType=BIGINT}"
    })
