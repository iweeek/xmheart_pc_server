...
public interface XPWArticleMapper {
    ...
    @Insert({ "insert into xpw_article (column_id, column_name, ", "title, url, img_url, ", "brief, is_pinned, ",
            "tags, publish_time, ", "content)", "values (#{columnId,jdbcType=BIGINT}, #{columnName,jdbcType=VARCHAR}, ",
            "#{title,jdbcType=VARCHAR}, #{url,jdbcType=VARCHAR}, #{imgUrl,jdbcType=VARCHAR}, ",
            "#{brief,jdbcType=VARCHAR}, #{isPinned,jdbcType=TINYINT}, ",
            "#{tags,jdbcType=VARCHAR}, #{publishTime,jdbcType=TIMESTAMP}, ", "#{content,jdbcType=LONGVARCHAR})" })
     ...
     * @mbg.generated  Sun Sep 24 20:45:29 CST 2017
     */
    @Select({ "select", "id, column_id, column_name, title, url, img_url, brief, is_pinned, tags, publish_time, ",
            "content", "from xpw_article", "where id = #{id,jdbcType=BIGINT}" })
    ...
    @Update({ "update xpw_article", "set column_id = #{columnId,jdbcType=BIGINT},",
            ...
            "tags = #{tags,jdbcType=VARCHAR},", "publish_time = #{publishTime,jdbcType=TIMESTAMP},",
