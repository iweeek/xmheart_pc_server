...
public interface XPWArticleMapper {
     ...
     * @mbg.generated  Thu Sep 21 15:03:21 CST 2017
     */
     ...
     * @mbg.generated  Thu Sep 21 15:03:21 CST 2017
     */
    @Insert({ "insert into xpw_article (column_id, column_name, ", "title, url, img_url, ", "is_pinned, tags, ",
            "publish_time, brief, ", "content)",
            ...
            "#{isPinned,jdbcType=TINYINT}, #{tags,jdbcType=VARCHAR}, ",
            "#{publishTime,jdbcType=TIMESTAMP}, #{brief,jdbcType=LONGVARCHAR}, ", "#{content,jdbcType=LONGVARCHAR})" })
    @SelectKey(statement = "SELECT LAST_INSERT_ID()", keyProperty = "id", before = false, resultType = Long.class)
    int insert(XPWArticleWithBLOBs record);

    /**
     * This method was generated by MyBatis Generator. This method corresponds to the database table xpw_article
     * @mbg.generated  Thu Sep 21 15:03:21 CST 2017
     */
    int insertSelective(XPWArticleWithBLOBs record);

    /**
     * This method was generated by MyBatis Generator. This method corresponds to the database table xpw_article
     * @mbg.generated  Thu Sep 21 15:03:21 CST 2017
     */
    List<XPWArticleWithBLOBs> selectByExampleWithBLOBs(XPWArticleExample example);
     ...
     * @mbg.generated  Thu Sep 21 15:03:21 CST 2017
     */
    @Select({ "select", "id, column_id, column_name, title, url, img_url, is_pinned, tags, publish_time, ",
            "brief, content", "from xpw_article", "where id = #{id,jdbcType=BIGINT}" })
    @ResultMap("com.xmheart.mapper.XPWArticleMapper.ResultMapWithBLOBs")
    XPWArticleWithBLOBs selectByPrimaryKey(Long id);

    /**
     * This method was generated by MyBatis Generator. This method corresponds to the database table xpw_article
     * @mbg.generated  Thu Sep 21 15:03:21 CST 2017
     */
    int updateByExampleSelective(@Param("record") XPWArticleWithBLOBs record,
            @Param("example") XPWArticleExample example);

    /**
     * This method was generated by MyBatis Generator. This method corresponds to the database table xpw_article
     * @mbg.generated  Thu Sep 21 15:03:21 CST 2017
     */
    int updateByExampleWithBLOBs(@Param("record") XPWArticleWithBLOBs record,
            @Param("example") XPWArticleExample example);
     ...
     * @mbg.generated  Thu Sep 21 15:03:21 CST 2017
     */
    int updateByPrimaryKeySelective(XPWArticleWithBLOBs record);
    ...
    @Update({ "update xpw_article", "set column_id = #{columnId,jdbcType=BIGINT},",
            ...
            "is_pinned = #{isPinned,jdbcType=TINYINT},", "tags = #{tags,jdbcType=VARCHAR},",
            "publish_time = #{publishTime,jdbcType=TIMESTAMP},", "brief = #{brief,jdbcType=LONGVARCHAR},",
            "content = #{content,jdbcType=LONGVARCHAR}", "where id = #{id,jdbcType=BIGINT}" })
    int updateByPrimaryKeyWithBLOBs(XPWArticleWithBLOBs record);
