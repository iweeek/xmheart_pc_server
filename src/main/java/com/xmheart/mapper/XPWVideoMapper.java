...
public interface XPWVideoMapper {
     ...
     * @mbg.generated  Mon Oct 23 15:36:34 CST 2017
     */
    @Insert({ "insert into xpw_video (title, url, ", "img_url, brief, is_pinned, ", "is_published, publish_time, ",
            "video_url)", "values (#{title,jdbcType=VARCHAR}, #{url,jdbcType=VARCHAR}, ",
            "#{imgUrl,jdbcType=VARCHAR}, #{brief,jdbcType=VARCHAR}, #{isPinned,jdbcType=TINYINT}, ",
            "#{isPublished,jdbcType=TINYINT}, #{publishTime,jdbcType=TIMESTAMP}, ", "#{videoUrl,jdbcType=VARCHAR})" })
     ...
     * @mbg.generated  Mon Oct 23 15:36:34 CST 2017
     */
    @Select({ "select", "id, title, url, img_url, brief, is_pinned, is_published, publish_time, video_url",
    ...
    @Update({ "update xpw_video", "set title = #{title,jdbcType=VARCHAR},", "url = #{url,jdbcType=VARCHAR},",
            "img_url = #{imgUrl,jdbcType=VARCHAR},", "brief = #{brief,jdbcType=VARCHAR},",
            "is_pinned = #{isPinned,jdbcType=TINYINT},", "is_published = #{isPublished,jdbcType=TINYINT},",
            "publish_time = #{publishTime,jdbcType=TIMESTAMP},", "video_url = #{videoUrl,jdbcType=VARCHAR}",
