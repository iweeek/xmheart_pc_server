...
public interface XPWIndexMapper {
    ...
    @Insert({ "insert into xpw_index (banner_image_1_url, banner_image_1_action_url, ",
            ...
            "banner_article_1_url, banner_article_1_brief, ", "banner_article_2_url, banner_article_2_brief, ",
            "banner_article_3_url, banner_article_3_brief)",
    ...
    @Select({ "select",
            ...
            "banner_image_3_url, banner_image_3_action_url, banner_article_1_url, banner_article_1_brief, ",
            "banner_article_2_url, banner_article_2_brief, banner_article_3_url, banner_article_3_brief",
            "from xpw_index", "where id = #{id,jdbcType=BIGINT}" })
