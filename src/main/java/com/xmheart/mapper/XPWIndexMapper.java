...
public interface XPWIndexMapper {
     ...
     * This method corresponds to the database table xpw_index
     *
     ...
     */
    @Insert({
        "insert into xpw_index (banner_image_1_url, banner_image_2_url, ",
        "banner_image_3_url, banner_article_1_url, ",
        "banner_article_1_brief, banner_article_2_url, ",
        "banner_article_2_brief, banner_article_3_url, ",
        "banner_article_3_brief)",
        "values (#{bannerImage1Url,jdbcType=VARCHAR}, #{bannerImage2Url,jdbcType=VARCHAR}, ",
        "#{bannerImage3Url,jdbcType=VARCHAR}, #{bannerArticle1Url,jdbcType=VARCHAR}, ",
        "#{bannerArticle1Brief,jdbcType=VARCHAR}, #{bannerArticle2Url,jdbcType=VARCHAR}, ",
        "#{bannerArticle2Brief,jdbcType=VARCHAR}, #{bannerArticle3Url,jdbcType=VARCHAR}, ",
    ...
    @Select({
        "select",
        "id, banner_image_1_url, banner_image_2_url, banner_image_3_url, banner_article_1_url, ",
        "banner_article_1_brief, banner_article_2_url, banner_article_2_brief, banner_article_3_url, ",
        "banner_article_3_brief",
        "from xpw_index",
        "where id = #{id,jdbcType=BIGINT}"
    })
    ...
    @Update({
        "update xpw_index",
        "set banner_image_1_url = #{bannerImage1Url,jdbcType=VARCHAR},",
