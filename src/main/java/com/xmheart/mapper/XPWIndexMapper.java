...
public interface XPWIndexMapper {
    ...
    @Insert({ "insert into xpw_index (banner_image_1_url, banner_image_1_action_url, ",
            ...
            "banner_article_1_title, banner_article_1_url, ", "banner_article_1_brief, banner_article_2_title, ",
            "banner_article_2_url, banner_article_2_brief, ", "banner_article_3_title, banner_article_3_url, ",
            "banner_article_3_brief)",
            ...
            "#{bannerArticle1Brief,jdbcType=VARCHAR}, #{bannerArticle2Title,jdbcType=VARCHAR}, ",
            ...
            "#{bannerArticle3Brief,jdbcType=VARCHAR})" })
    ...
    @Select({ "select",
            ...
            "banner_article_1_brief, banner_article_2_title, banner_article_2_url, banner_article_2_brief, ",
            "banner_article_3_title, banner_article_3_url, banner_article_3_brief", "from xpw_index",
    ...
    @Update({ "update xpw_index", "set banner_image_1_url = #{bannerImage1Url,jdbcType=VARCHAR},",
            ...
            "banner_article_3_brief = #{bannerArticle3Brief,jdbcType=VARCHAR}", "where id = #{id,jdbcType=BIGINT}" })
