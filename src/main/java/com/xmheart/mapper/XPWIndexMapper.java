...
public interface XPWIndexMapper {
     ...
     * @mbg.generated  Mon Oct 23 12:36:16 CST 2017
     */
    @Insert({ "insert into xpw_index (banner_image_1_url, banner_image_1_action_url, ",
            "banner_image_2_url, banner_image_2_action_url, ", "banner_image_3_url, banner_image_3_action_url, ",
            "banner_article_1_title, banner_article_1_url, ", "banner_article_1_brief, banner_article_1_tag, ",
            "banner_article_2_title, banner_article_2_url, ", "banner_article_2_brief, banner_article_2_tag, ",
            "banner_article_3_title, banner_article_3_url, ", "banner_article_3_brief, banner_article_3_tag)",
            ...
            "#{bannerArticle1Title,jdbcType=VARCHAR}, #{bannerArticle1Url,jdbcType=VARCHAR}, ",
            "#{bannerArticle1Brief,jdbcType=VARCHAR}, #{bannerArticle1Tag,jdbcType=VARCHAR}, ",
            "#{bannerArticle2Title,jdbcType=VARCHAR}, #{bannerArticle2Url,jdbcType=VARCHAR}, ",
            "#{bannerArticle2Brief,jdbcType=VARCHAR}, #{bannerArticle2Tag,jdbcType=VARCHAR}, ",
            "#{bannerArticle3Title,jdbcType=VARCHAR}, #{bannerArticle3Url,jdbcType=VARCHAR}, ",
            "#{bannerArticle3Brief,jdbcType=VARCHAR}, #{bannerArticle3Tag,jdbcType=VARCHAR})" })
    ...
    @Select({ "select",
            ...
            "banner_image_3_url, banner_image_3_action_url, banner_article_1_title, banner_article_1_url, ",
            "banner_article_1_brief, banner_article_1_tag, banner_article_2_title, banner_article_2_url, ",
            "banner_article_2_brief, banner_article_2_tag, banner_article_3_title, banner_article_3_url, ",
            "banner_article_3_brief, banner_article_3_tag", "from xpw_index", "where id = #{id,jdbcType=BIGINT}" })
     ...
     * @mbg.generated  Mon Oct 23 12:36:16 CST 2017
     */
    @Update({ "update xpw_index", "set banner_image_1_url = #{bannerImage1Url,jdbcType=VARCHAR},",
