...
public interface XPWNavMapper {
	...
	@Insert({ "insert into xpw_nav (column_id, column_name, ", "child_column_name, article_title, ",
			"url, img_url, publish_time, ", "created_time, updated_time)",
			...
			"#{url,jdbcType=VARCHAR}, #{imgUrl,jdbcType=VARCHAR}, #{publishTime,jdbcType=TIMESTAMP}, ",
	 ...
	 * @mbg.generated  Thu Sep 07 18:48:01 CST 2017
	 */
	@Select({ "select", "id, column_id, column_name, child_column_name, article_title, url, img_url, ",
			"publish_time, created_time, updated_time", "from xpw_nav", "where id = #{id,jdbcType=BIGINT}" })
	...
	@Update({ "update xpw_nav", "set column_id = #{columnId,jdbcType=BIGINT},",
			...
			"img_url = #{imgUrl,jdbcType=VARCHAR},", "publish_time = #{publishTime,jdbcType=TIMESTAMP},",
