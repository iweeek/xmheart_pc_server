...
public interface XPWNavMapper {
	...
	@Insert({ "insert into xpw_nav (column_id, column_name, ", "child_column_name, article_title, ",
			"brief, url, img_url, ", "publish_time)",
			...
			"#{brief,jdbcType=VARCHAR}, #{url,jdbcType=VARCHAR}, #{imgUrl,jdbcType=VARCHAR}, ",
	 ...
	 * @mbg.generated  Thu Oct 26 15:17:32 CST 2017
	 */
	@Select({ "select", "id, column_id, column_name, child_column_name, article_title, brief, url, img_url, ",
			"publish_time", "from xpw_nav", "where id = #{id,jdbcType=BIGINT}" })
