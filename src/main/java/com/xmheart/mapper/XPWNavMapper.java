...
public interface XPWNavMapper {
	 ...
	 * @mbg.generated  Tue Sep 05 19:33:09 CST 2017
	 */
	@Insert({ "insert into xpw_nav (column_name, parent_column, ", "article_title, url, ", "img_url, publish_time, ",
			"created_time, updated_time)", "values (#{columnName,jdbcType=VARCHAR}, #{parentColumn,jdbcType=VARCHAR}, ",
			"#{articleTitle,jdbcType=VARCHAR}, #{url,jdbcType=VARCHAR}, ",
			"#{imgUrl,jdbcType=VARCHAR}, #{publishTime,jdbcType=TIMESTAMP}, ",
	 ...
	 * @mbg.generated  Tue Sep 05 19:33:09 CST 2017
	 */
	@Select({ "select", "id, column_name, parent_column, article_title, url, img_url, publish_time, created_time, ",
			"updated_time", "from xpw_nav", "where id = #{id,jdbcType=BIGINT}" })
	 ...
	 * @mbg.generated  Tue Sep 05 19:33:09 CST 2017
	 */
	@Update({ "update xpw_nav", "set column_name = #{columnName,jdbcType=VARCHAR},",
			"parent_column = #{parentColumn,jdbcType=VARCHAR},", "article_title = #{articleTitle,jdbcType=VARCHAR},",
