...
public interface XPWNavMapper {
     ...
     * This method corresponds to the database table xpw_nav
     *
     ...
     */
    @Insert({
        "insert into xpw_nav (column_id, column_name, ",
        "child_column_name, article_title, ",
        "url, img_url, publish_time)",
    ...
    @Select({
        "select",
        "id, column_id, column_name, child_column_name, article_title, url, img_url, ",
        "publish_time",
        "from xpw_nav",
        "where id = #{id,jdbcType=BIGINT}"
    })
